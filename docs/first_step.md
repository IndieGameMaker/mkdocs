...
![](images/lecture01/02.png)

5. 에셋스토어에서 Mummy로 검색해 다음 리소스를 내려받는다.

![](images/lecture01/03.png)
...
5. Mummy_mom 모델을 Stage01 하위에 차일드화 시킨 후 이름을 Agent로 변경하고 머티리얼을 적용한다.
...
```
![](images/lecture01/15.png)

## Academy에 브레인 연결

![](images/lecture01/16.png)
